    ...
    () => [
      {
        ...
        photo:
          "https://lh3.googleusercontent.com/a-/ALV-UjWa7otZFCegWNCvu9f8yqHJbjEGMegGpCCF2tKDT5opXNepzfu4=w64-h64-c-rp-mo-br100",
      },
      {
        name: "Edina Luz",
        date: "14/01/2025",
        ...
        photo:
          "https://lh3.googleusercontent.com/a-/ALV-UjVbdg4wsLwNLYTM3rKNMMktnqjwJYtnXVM6JNSL6XbV0hze9VS-WQ=w64-h64-c-rp-mo-br100",
      },
      {
        ...
        photo:
          "https://lh3.googleusercontent.com/a-/ALV-UjV9s9PdieoKxvxxzfifMfyPz4mxBdgrjVjoASFqlVka_vbG7oNH=w64-h64-c-rp-mo-br100",
      },
      {
        ...
        photo:
          "https://lh3.googleusercontent.com/a-/ALV-UjXUDZ3ZtrvsY7xlZ-8QzyZPdity51y5msXVqdUsLzgpzR3lVZ96=w64-h64-c-rp-mo-br100",
      },
      {
        name: "Marcelo Silva",
        date: "17/12/2022",
        ...
        photo:
          "https://lh3.googleusercontent.com/a/ACg8ocIynyPuwk8oBBOFdHRliET6_q4oux-huH5G4qAFI0j_oNAVwQ=w64-h64-c-rp-mo-br100",
      },
      {
        name: "Márcia Martins",
        date: "11/10/2022",
      ...
      },
      {
        ...
        photo:
          "https://lh3.googleusercontent.com/a-/ALV-UjUKseMivGVHL_lEc2oFN61tV8M-iJbSi46lEavbLk6EOeidzs8Rog=w64-h64-c-rp-mo-br100",
      },
      {
        name: "Leo Vicente",
        date: "21/09/2022",
        ...
        photo:
          "https://lh3.googleusercontent.com/a-/ALV-UjWzT65tcjIWwC-JFmBlp6LP3wfOfufbwfdWP54TI5UTPeuygAR9hw=w64-h64-c-rp-mo-ba2-br100",
      },
      {
        ...
        photo:
          "https://lh3.googleusercontent.com/a-/ALV-UjVCueK5Njbt6F-IBt2BY3Jda2EyFNb7U7VXEFSqWg659xoQvfgk5g=w64-h64-c-rp-mo-br100",
      },
    ],
    []
  );
  ...
  const treatments = [
    {
      ...
      title: "Ansiedade",
      description:
        "Sofre com episódios de ansiedade, estresse, ataques do pânico ou distúrbios do sono.",
    },
    {
      icon: <FaHeadSideVirus className="treatment-icon" />,
      title: "Depressão",
      description:
        "Tratamento especializado para quadros depressivos e alterações de humor.",
    },
    {
      icon: <FaBrain className="treatment-icon" />,
      title: "TDAH",
      description:
        "Acompanhamento para Transtorno de Déficit de Atenção e Hiperatividade.",
    },
    {
      icon: <FaChild className="treatment-icon" />,
      title: "Autismo",
      description:
        "Suporte especializado para Transtorno do Espectro Autista (TEA).",
    },
    {
    ...
    },
    {
      ...
      description:
        "Auxílio na escolha profissional e desenvolvimento de carreira.",
    },
  ];
      ...
      <div className="treatments-container">
        <div className="section-header">
          ...
          <p className="subtitle">
            A Hipnoterapia pode beneficiar qualquer pessoa que esteja sofrendo
            com dores emocionais.
          </p>
        ...
        <div className="treatment-cards-container">
          {treatments.map((treatment, index) => (
            <div className="treatment-card" key={index}>
              <div className="icon-container">{treatment.icon}</div>
        ...
        <div className="treatment-details">
          ...
          <div className="features-column">
            ...
            <FeatureList />
            <button className="appointment-button">Agende sua consulta</button>
          </div>
        </div>
                    ...
                    {reviewGroups.map((group, groupIndex) => (
                      ...
                      >
                        {group.map((review, indexInGroup) => {
                          const originalIndex =
                            groupIndex * visibleCards + indexInGroup;
                          const heightInfo = contentHeights[originalIndex] || {
                            initial: 100,
                            expanded: 0,
                          };

                          return (
                            <div key={originalIndex} className="ti-review-item">
                              <div className="ti-inner">
                                ...
                                <div
                                  ref={(el) =>
                                    (contentRefs.current[originalIndex] = el)
                                  }
